...
import { reloadReduxData, setAvatarServer} from "../../../redux/reducers/requests";
import {useAppDispatch, useAppSelector} from "../../../hooks/redux";
import Cookies from "js-cookie";
import {set} from "react-hook-form";
import defaultLogo from '../../../images/default-avatar.jpg'
import ActivateAlert from "../../unActivatedAccount/ActivateAlert";
import {AlertActions} from "../../../redux/reducers/Alert-slice";
import ChangeProfile from "./modal-changeProfile/changeProfile";
...
const {isActivated} = useAppSelector(state => state.UserInfoReducer.user)
const handleOpenModal = ()=>{
        if(!isActivated){
        return    handleClickAlert()
        }
        else{
            dispatch(setShowModalState('grid'))
        }
}
    ...
    return (
        ...
        <Block>
            ...
            <button onClick={handleOpenModal} className={'editProfile'}>
