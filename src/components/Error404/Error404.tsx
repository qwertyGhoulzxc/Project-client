...
import {FullPage} from "./errorStyle";
...
const Error404 = () => {
    ...
    return (
        <FullPage>
            <div>
        <h1>404</h1>
            <p>К сожалению такой страницы не существует,<br/>но существует instagram разработчика<br/>inst: <a href={'https://www.instagram.com/_pepsi_cherry_/'}>_pepsi_cherry_</a></p>
